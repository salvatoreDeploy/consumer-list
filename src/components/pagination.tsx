...
export function Pagination({ items, page, pages }: PaginationProps) {
  ...
  const [optionSelected, setOptionSelected] = useState<string>('10')

  function handleSelectedItemPerPage(newOption: string) {
    const optionSelected = newOption

    setOptionSelected(optionSelected)

    perPage(optionSelected)
  }
    ...
    <div className="flex text-sm items-center justify-between text-zinc-500">
      ...
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-2">
          ...
          <Select defaultValue="10" value={optionSelected} onValueChange={handleSelectedItemPerPage}>
